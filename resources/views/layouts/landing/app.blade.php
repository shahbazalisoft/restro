        ...
        <div class="navbar-bottom">
            <div class="container">
                <div class="navbar-bottom-wrapper">
                    ...
                    @endif
                    <div class="dropdown--btn-hover position-relative me-3">
                        <a class="dropdown--btn header--btn text-capitalize d-flex align-items-center" href="{{ route('restaurant.create') }}">
                            <span class="me-1">{{ translate('JoinUs') }}</span>
