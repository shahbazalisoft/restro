...
class VendorController extends Controller
{
    ...
    public function view(Request $request,$store_id, $tab=null, $sub_tab='cash')
    {
        ...
        return view('admin-views.vendor.view.index', compact('store'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $stores = Store::with('vendor')->whereHas('vendor', function($query){
        ...
        $total_transaction = 1;
        $comission_earned = max(0,1);

        $store_withdraws = 1;

        return view('admin-views.vendor.list', compact('stores', 'type','total_store','active_stores','inactive_stores','recent_stores','total_transaction' ,'comission_earned','store_withdraws'));
    }
