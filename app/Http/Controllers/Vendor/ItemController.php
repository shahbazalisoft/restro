...
class ItemController extends Controller
{
    public function index()
    {
        ...
        return view('vendor-views.product.index', compact('categories', 'conditions', 'brands'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('vendor-views.product.edit', compact('product', 'product_category', 'categories', 'temp_product', 'conditions', 'brands'));
    }
